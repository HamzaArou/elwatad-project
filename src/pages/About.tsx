  ...
  return <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0">
          <img src="/lovable-uploads/6bb40572-541a-4211-ad9e-8db2956d65da.png" alt="وتد الكيان العقارية" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/50 to-black/70" />
        </div>
        <div className="relative z-10 text-center text-white">
          <h1 className="md:text-7xl font-bold mb-4 animate-fade-in text-7xl">من نحن</h1>
          <p className="md:text-2xl animate-fade-in delay-200 text-2xl">تعرف على وتد الكيان العقارية</p>
        </div>
      </section>
