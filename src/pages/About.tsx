  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "قبل 3 أيام",
      text: "ماشاء الله تبارك الله عليكم التعامل معكم شفاف جدا ومريح الله يعطيكم العافية على صدقها وامانتها اشكر اختي ميثم الصاعدي جزاها الله خير اشهد انها ماقصرت",
      avatar: "م"
    },
    {
      author: "ياسمين ميليباري",
      rating: 5,
      date: "قبل أسبوع",
      text: "شكرا جزيلا لشركة وتد الكيان وموظفيها الرائعين بفضل الله ثم معلمتها ميسم الصاعدي امتلكت بيت 🏠😍 الله يبارك فيها هي راقيه جدا وطيبه ومحترمه جدا الله يوفقها ويسعدها",
      avatar: "ي"
    },
    {
      author: "مودي العتيبي",
      rating: 5,
      date: "قبل أسبوع",
      text: "اشكر شركة وتد العقاريه على سرعة العمل معي وتعاملهم الراقي وادبهم ومعاملتهم الطيبه كما اشكر الاستاذ وليد والاستاذ عبدالمجيد والاخت فاديه على حسن التعامل معنا والخدمات المقدمه لي",
      avatar: "م"
    },
    {
      author: "منصور يماني",
      rating: 5,
      date: "قبل شهرين",
      text: "ماشاء الله تبارك الله عليكم التعامل معكم شفاف جدا ومريح الله يعطيكم العافية على صدقها وامانتها اشكر الاخت رنا الضادي جزاها الله خير اشهد انها ماقصرت",
      avatar: "م"
    },
    {
      author: "عبدالكريم التكروني",
      rating: 5,
      date: "قبل أسبوعين",
      text: "التعامل راقي جدا وشفاف وخاصة الاخت ميسم الصاعدي كانت خير مثال في فن التعامل والشكر موصول لها ولجميع الاخوات اللي تعاملت معهم ومنهم الاخت رنا يماني💐",
      avatar: "ع"
    },
    {
      author: "تركي الحربي",
      rating: 5,
      date: "قبل 3 أشهر",
      text: "نبدأ بقول السلام اول الله يعطيكم العافية ان شاء الله بارك الله فيكم الحمدلله حصلت على البيت عن طريق شركة وتد الكيان",
      avatar: "ت"
    },
    {
      author: "نجوى القرشي",
      rating: 5,
      date: "قبل 5 أشهر",
      text: "عطيتكم 5 نجوم لاسباب خاصه الاخت رنا اليماني ماشاءالله عليهم حريصين سريعين مجتهدين في عملهم الله يسعدهم",
      avatar: "ن"
    },
    {
      author: "عبدالله حوساوي",
      rating: 5,
      date: "قبل شهر",
      text: "ماشاء الله تبارك الرحمن فريق عمل ممتاز وتعامل راقي جدا الشكر الجزيل للأستاذة ميسم",
      avatar: "ع"
    }
  ];
