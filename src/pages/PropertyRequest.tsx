...
const PropertyRequest = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const {
        error
      } = await supabase.from('property_requests').insert([formData]);
  ...
  return <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mt-20 mb-6">طلب عقار</h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup value={formData.city} onValueChange={value => setFormData({
                ...formData,
                city: value
              ...
              <div className="space-y-2">
                ...
                <RadioGroup value={formData.property_type} onValueChange={value => setFormData({
                ...formData,
                property_type: value
              ...
              <Button type="submit" className="w-full bg-gold hover:bg-gold/90 text-white" disabled={isSubmitting}>
