      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {services.map((service, index) => (
            <Card 
              key={index} 
              className="bg-white hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border-2 hover:border-[#B69665]"
            >
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-bold text-[#2F4447] mb-3">
                  {service.title}
                </h3>
