        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full md:w-1/2 relative z-10">
              <img alt="Modern House" src="/lovable-uploads/90df05aa-e9fa-440d-b210-f7581e0252c8.png" className="w-full h-auto rounded-3xl object-fill" />
            </div>
            ...
            <div className="w-full md:w-1/2 text-right space-y-6 py-[32px] px-[63px] mx-0 my-[22px]">
              ...
              <div className="pt-6">
                <Button className="bg-gold hover:bg-gold/90 text-white px-8 py-6 text-xl rounded-md transition-all duration-300 hover:scale-105" onClick={handleNavigation}>
                  اطلب الآن
                </Button>
              </div>
            </div>
