        ...
        <div className="max-w-[1200px] mx-auto px-4 py-0 -mt-3">
          ...
          <div className="flex justify-center mt-8">
            <Button 
              ...
              className="bg-[#B69665] hover:bg-[#B69665]/90 text-white font-bold text-lg px-8 py-4 rounded-full shadow-lg transition duration-200 ease-in-out transform hover:-translate-y-1 hover:scale-105"
            >
              عرض كل العقارات
            </Button>
          </div>
