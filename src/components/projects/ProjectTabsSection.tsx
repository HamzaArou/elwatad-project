      ...
      <div className="container mx-auto px-4">
        <Tabs defaultValue="details" className="w-full" dir="rtl">
          <div className="flex justify-center mb-12">
            <TabsList className="bg-white/80 backdrop-blur-lg shadow-lg rounded-2xl p-1.5 border border-white/20 hover:shadow-xl transition-all duration-300">
              <TabsTrigger 
                value="details" 
                className="gap-3 px-6 py-3 text-base font-medium transition-all duration-300 data-[state=active]:bg-deepBlue data-[state=active]:text-white"
              >
          ...
          <TabsContent value="details" className="mt-6 focus-visible:outline-none focus-visible:ring-0">
            <div className="bg-white/90 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
              {details ? (
                ...
                <p className="text-center text-gray-500 py-8">لا توجد تفاصيل متاحة</p>
              )}
            </div>
          </TabsContent>
