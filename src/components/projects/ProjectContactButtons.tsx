...
export default function ProjectContactButtons({ className }: ProjectContactButtonsProps) {
  // Contact information
  ...
  return (
    <div className={`bg-white rounded-lg shadow-md p-6 ${className}`}>
      <div className="text-center mb-4">
        <h3 className="text-xl font-bold text-gray-800">تواصل مع البائع</h3>
        <p className="text-gray-600 mt-1">للاستفسار أو حجز موعد</p>
      </div>
